...
/**
 * [DIC20] S3 — DIC not yet action (S3 OE - VD No Action)
 *
 * Spreadsheet Reference (Row 71):
 * - Code         : DIC20
 * - DIC Action   : Not yet action (S3 OE - VD No Action)
 * - UI VD        : Need Action    (VD no_action → status_vendor=PENDING(0))
 * - UI VA        : Waiting User   (VA submitted OE → status_vendor=APPROVE, milestone=WAITING_DIC_APPROVAL)
 ...
 */
describe('[DIC20] S3 — DIC not yet action (S3 OE - VD No Action)', () => {
  let ctx;
