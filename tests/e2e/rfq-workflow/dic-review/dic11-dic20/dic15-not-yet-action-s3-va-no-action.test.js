...
/**
 * [DIC15] S3 — DIC not yet action (S3 - VA No Action)
 *
 * Spreadsheet Reference (Row 66):
 * - Code         : DIC15
 * - DIC Action   : Not yet action (S3  - VA No Action)
 * - UI VD        : Waiting User   (VD submitted → status_vendor=APPROVE, milestone=WAITING_DIC_APPROVAL)
 ...
 */
describe('[DIC15] S3 — DIC not yet action (S3 - VA No Action)', () => {
  let ctx;
