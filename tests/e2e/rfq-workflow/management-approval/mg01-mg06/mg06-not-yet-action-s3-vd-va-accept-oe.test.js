...
describe('[MG06] MG06 — Management not yet action S3 (VD accept, VA accept, DIC chose VA)', () => {
  let ctx;

  beforeAll(async () => {
    ctx = await setupRFQAtManagementStage({ vd: 'accept', va: 'accept' }, 'accept_va', {}, {}, { scenario: 's3' });
  }, 90000);
