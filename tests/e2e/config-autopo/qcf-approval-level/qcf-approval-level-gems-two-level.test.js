...
describe('E2E: qcf_approval_level = "category leader, management" (Two Level) - GEMS Server Group', () => {
  let adminToken;
  let csToken;
  ...
  describe('Step 1: PR Import and RFQ Generation', () => {
    test('should generate RFQ for GEMS with two-level approval config', async () => {
  ...
  describe('Step 2: QCF Approval Level Config Validation', () => {
    test('should have qcf_approval_level = "category leader, management" for GEMS', async () => {
    ...
    test('should have Waiting_Management_review_expiry SLA config for GEMS', async () => {
