...
describe('E2E: hide_oe_in_vendor_rfq = "no" (Show OE) - GEMS Server Group', () => {
  let adminToken;
  let csToken;
  ...
  describe('Step 1: PR Import and RFQ Generation', () => {
    test('should generate RFQ for GEMS with hide_oe_in_vendor_rfq = "no"', async () => {
  ...
  describe('Step 2: hide_oe_in_vendor_rfq Config Validation', () => {
    test('should have hide_oe_in_vendor_rfq = "no" active for GEMS', async () => {
    ...
    test('should have hide_price_negotiation config for GEMS', async () => {
