...
describe('E2E: hide_oe_in_vendor_rfq = "yes" - GEMS Server Group', () => {
  let adminToken;
  let csToken;
  ...
  describe('Step 1: PR Import and RFQ Generation', () => {
    test('should generate RFQ for GEMS with hide_oe_in_vendor_rfq = "yes"', async () => {
  ...
  describe('Step 2: hide_oe_in_vendor_rfq Config Validation', () => {
    test('should have hide_oe_in_vendor_rfq = "yes" active for GEMS', async () => {
