...
describe('E2E: hide_price_negotiation = "no" - BCG Server Group', () => {
  let adminToken;
  let csToken;
  ...
  describe('Step 1: PR Import and RFQ Generation', () => {
    test('should generate RFQ for BCG with hide_price_negotiation = "no"', async () => {
  ...
  describe('Step 2: hide_price_negotiation Config Validation', () => {
    test('should have hide_price_negotiation = "no" active for BCG', async () => {
