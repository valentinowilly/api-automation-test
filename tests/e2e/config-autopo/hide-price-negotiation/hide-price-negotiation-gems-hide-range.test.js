...
describe('E2E: hide_price_negotiation = "yes" (Hide Range) - GEMS Server Group', () => {
  let adminToken;
  let csToken;
  ...
  describe('Step 1: PR Import and RFQ Generation', () => {
    test('should generate RFQ for GEMS with hide_price_negotiation = "yes"', async () => {
  ...
  describe('Step 2: hide_price_negotiation Config Validation', () => {
    test('should have hide_price_negotiation = "yes" active for GEMS', async () => {
