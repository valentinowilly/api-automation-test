...
export const authenticatedPut = async (url, data, token, options = {}) => {
...
export const authenticatedPatch = async (url, data, token, options = {}) => {
...
export const authenticatedDelete = async (url, token, options = {}) => {
...
export const uploadFile = async (url, file, token, fieldName = 'file', additionalFields = {}) => {
...
export const uploadMultipleFiles = async (url, files, token, fieldName = 'files', additionalFields = {}) => {
  const FormData = (await import('form-data')).default;
  const formData = new FormData();
